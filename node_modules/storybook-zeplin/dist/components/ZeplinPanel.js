...
const ZeplinPanel = ({ zeplinLink }) => {
    ...
    const designLink = selectedLink || (Array.isArray(zeplinLink) ? (_a = zeplinLink[0]) === null || _a === void 0 ? void 0 : _a.link : zeplinLink);
    ...
    const { name, image: { original_url, width, height }, updated, } = zeplinData;
